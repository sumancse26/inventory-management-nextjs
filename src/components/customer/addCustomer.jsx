      ...
      <div className="bg-white dark:bg-neutral-800 rounded-2xl shadow-2xl w-full max-w-md p-6 relative transform transition-all duration-300 scale-100 animate-fadeIn">
        ...
        <form className="space-y-4" onSubmit={saveBtnHandler}>
          ...
          <div className="flex gap-3 pt-4 justify-center">
            ...
            <button
              type="submit"
              className="px-4 py-2 text-sm font-medium rounded-lg text-white bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-purple-500 transition"
            >
              Save Changes
            </button>
          </div>
