...
const Nav = () => {
  return (
    <div className="fixed left-0 top-0 h-full w-64 bg-white shadow-lg dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transition-all duration-300 ease-in-out">
      {/* Logo Section */}
