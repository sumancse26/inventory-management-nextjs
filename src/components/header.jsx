      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className="md:hidden p-2 rounded-full text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500">
              <svg
                className="h-6 w-6"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
            ...
            {/* Notifications */}
            <button className="p-2 rounded-full text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 relative focus:outline-none focus:ring-2 focus:ring-indigo-500">
              <svg
                className="h-6 w-6"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
            ...
            <div className="relative">
              ...
              {/* Dropdown Menu */}
              <div className="hidden absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
                <a
                  href="#"
