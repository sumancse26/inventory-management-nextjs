      ...
      <div className="relative w-full max-w-md bg-white dark:bg-neutral-800 rounded-2xl shadow-xl p-6 animate-fadeIn">
        ...
        <form className="space-y-5">
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <button
              type="submit"
              className="px-5 py-2 text-sm font-semibold text-white bg-gradient-to-r from-purple-600 to-indigo-600 rounded-md shadow hover:from-purple-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-purple-500"
            >
              Save
            </button>
          </div>
